...
const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Separate dark mode loading to prevent re-applying body classes unnecessarily
        ...
        // Set saved dark mode and background theme
    ...
    // Consolidated effect for managing body classes and saving theme settings
    useEffect(() => {
...
const SettingsModal: React.FC<{
    ...
    const handleCreateShareLink = () => {
        try {
            ...
            setAlertConfig({
                title: t('ai_sort_error_title'), // Re-using a generic error title
                message: '공유 링크를 생성하는 데 실패했습니다. 데이터가 너무 클 수 있습니다.'
            });
        }
    };
    ...
    const handleCopyLink = () => {
        if (shareableLink) {
            navigator.clipboard.writeText(shareableLink).then(() => {
                ...
                setAlertConfig({
                    title: t('ai_sort_error_title'),
                    message: '클립보드에 복사하지 못했습니다. 브라우저가 HTTPS 환경이 아니거나 권한이 없을 수 있습니다.'
                });
            });
        }
    };
